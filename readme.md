# To use a mobile phone model you need to provide the trained model file (pt format) training process file and validation.

# Body

Please download the mobile model, provide the trained model file (pt format), process file and validation images, along with the corresponding training dataset of 8000 pieces. It is suitable for learning research and graduation projects.
